...
class Button:
    ...
    @staticmethod
    def inline(text, data=...): # -> KeyboardButtonCallback:
        """
    ...
    @staticmethod
    def switch_inline(text, query=..., same_peer=...): # -> KeyboardButtonSwitchInline:
        """
    ...
    @staticmethod
    def url(text, url=...): # -> KeyboardButtonUrl:
        """
    ...
    @staticmethod
    def auth(text, url=..., *, bot=..., write_access=..., fwd_text=...): # -> InputKeyboardButtonUrlAuth:
        """
    ...
    @classmethod
    def text(cls, text, *, resize=..., single_use=..., selective=...): # -> Self:
        """
    ...
    @classmethod
    def request_location(cls, text, *, resize=..., single_use=..., selective=...): # -> Self:
        """
    ...
    @classmethod
    def request_phone(cls, text, *, resize=..., single_use=..., selective=...): # -> Self:
        """
    ...
    @classmethod
    def request_poll(cls, text, *, force_quiz=..., resize=..., single_use=..., selective=...): # -> Self:
        """
    ...
    @staticmethod
    def clear(selective=...): # -> ReplyKeyboardHide:
        """
    ...
    @staticmethod
    def force_reply(single_use=..., selective=..., placeholder=...): # -> ReplyKeyboardForceReply:
        """
    ...
    @staticmethod
    def buy(text): # -> KeyboardButtonBuy:
        """
    ...
    @staticmethod
    def game(text): # -> KeyboardButtonGame:
        """
